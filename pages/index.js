...
import { Blocks, LineChart, Shield, Code2 } from 'lucide-react';

function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-950 to-indigo-950 text-white overflow-hidden">
        ...
        <div className="relative w-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              <h1 className="text-7xl font-bold mb-8 gradient-text tracking-tight">
                Building the Future of Analysis Tools
              </h1>
              <p className="text-xl text-purple-100/90 max-w-3xl mx-auto leading-relaxed">
                At Highpre, we're crafting sophisticated analysis tools that empower businesses 
                to make data-driven decisions with confidence and precision.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="gradient-border card-hover p-8">
                <div className="w-14 h-14 bg-purple-500/10 rounded-xl flex items-center justify-center mb-6">
                  <LineChart className="w-8 h-8 text-purple-200" />
                </div>
                <h3 className="text-2xl font-semibold text-purple-50 mb-4">DataFlow Analytics</h3>
                <p className="text-purple-200/80 leading-relaxed">
                  Advanced data analysis platform for real-time business insights
                </p>
              </div>
              ...
              <div className="gradient-border card-hover p-8">
                ...
                <h3 className="text-2xl font-semibold text-purple-50 mb-4">SecureMetrics</h3>
                <p className="text-purple-200/80 leading-relaxed">
                  Security-focused metrics and compliance monitoring system
                </p>
              </div>
              ...
              <div className="gradient-border card-hover p-8">
                ...
                <h3 className="text-2xl font-semibold text-purple-50 mb-4">CodeInsight</h3>
                <p className="text-purple-200/80 leading-relaxed">
                  Intelligent code analysis and optimization platform
                </p>
              </div>

              <div className="gradient-border card-hover p-8">
                <div className="w-14 h-14 bg-purple-500/10 rounded-xl flex items-center justify-center mb-6">
                  <Blocks className="w-8 h-8 text-purple-200" />
                </div>
                <h3 className="text-2xl font-semibold text-purple-50 mb-4">IntegrateHub</h3>
                <p className="text-purple-200/80 leading-relaxed">
                  Seamless integration platform for enterprise tools
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-purple-100/90 mb-8 leading-relaxed">
                Founded with a vision to revolutionize business analysis tools, Highpre is dedicated 
                to developing cutting-edge solutions that help organizations unlock their full potential. 
                Our upcoming suite of products combines advanced analytics, security, and integration 
                capabilities to deliver comprehensive business insights.
              </p>
              <p className="text-xl text-purple-100/90 leading-relaxed">
                Stay tuned as we prepare to launch our innovative tools designed to transform 
                how businesses analyze, secure, and optimize their operations.
              </p>
            </div>
          </div>
        </div>
